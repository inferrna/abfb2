define([],
function () {
    function JSUnzip(fileContents) {
        this.fileContents = new BigEndianBinaryStream(fileContents);
    }
    ...
    this.prototype = {
        readEntries: function () {
            ...
            this.entries = [];
            var e = new ZipEntry(this.fileContents);
            while (typeof(e.data) === "string") {
                this.entries.push(e);
                e = new ZipEntry(this.fileContents);
            }
        },
    ...
    ZipEntry = function (binaryStream) {
    ...
    BigEndianBinaryStream = function (stream) {
        this.stream = stream;
        this.resetByteIndex();
    }
    ...
    BigEndianBinaryStream.prototype = {
        ...
        getByteRangeAsString: function (index, steps) {
            ...
            var max = index + steps;
            var i = index;
            console.log("Some one uses getByteRangeAsString");
            while (i < max) {
